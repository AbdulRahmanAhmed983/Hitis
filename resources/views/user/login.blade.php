...
<div class="login-box no-js">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">تسجيل الدخول لطلاب لائحة الساعات المعتمدة</p>
            ...
            <p class="mt-3 mb-1 float-right" dir="rtl">
                <a href="{{route('forget.password.get')}}">هل نسيت كلمة المرور؟!</a>
            </p>
        </div>
        <!-- /.login-card-body -->
    </div>
    <div class="login-logo">
        <div class="image">
            <img src="{{asset('images/dahab2.png')}}" alt="Logo" class="w-100">
        </div>
    </div>
</div>
<div id="f-height"></div>
...
<script>
    ...
    @if($errors->any() or session()->has('success') or session()->has('error'))
