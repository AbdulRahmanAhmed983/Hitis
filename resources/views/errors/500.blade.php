...
<div class="no-js" style="margin-top: 10%">
    <div class="mx-auto col-8 text-center" style="height:fit-content;width:fit-content;">
        <h2 class="text-danger col-12" style="font-size: 120px;">500</h2>
        <div class="mx-2" dir="rtl">
            <h2><i class="fas fa-exclamation-triangle text-danger"></i> لسوء الحظ ، حدث خطأ ما.</h2>
            <p class="h5">نحن غير قادرين على تلبية طلبك. كن مطمئنًا ، انه ليس خطأك. يرجى تحديث المتصفح. إذا استمر الخطأ
                ، يرجى الاتصال بفريق الدعم الخاص بالمعهد.</p>
        </div>
    </div>
</div>
<!-- jQuery -->
