...
<div class="no-js" style="margin-top: 10%">
    <div class="mx-auto col-8 text-center" style="height:fit-content;width:fit-content;">
        <h2 class="text-danger col-12" style="font-size: 120px;">403</h2>
        <div class="mx-2" dir="rtl">
            <h2><i class="fas fa-skull-crossbones text-danger"></i> آسف لا يجوز تجاوز هذه النقطة!</h2>
            <p class="h5">
                هذه الصفحة ليست من صلاحياتك يرجى مراجعة مسؤول الموقع إذا كنت تعتقد أن هذا خطأ.
                <br>
                يمكنك العودة إلى <a href="{{route('dashboard')}}">صفحتك</a>
            </p>
        </div>
    </div>
</div>
