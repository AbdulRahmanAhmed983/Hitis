...
@section('content')
    <div class="row">
        <div class="col-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="username">كود الطلاب</label>
            ...
            @if(isset($alerts))
                @if(!empty($alerts))
                    <form action="{{route('student.delete.alert',['student_code'=>$alerts[0]->student_code])}}"
                          method="post">
                        @csrf
                        @method('delete')
                        <div class="card card-primary">
                                    ...
                                    @foreach($alerts as $alert)
                                        <tr @class(['bg-warning'=>($alert->status == 'warning'),
                                            ...
                                            <td class="align-middle">
                                                <div class="icheck-primary d-inline icheck-label">
                ...
                @endif
            @endif
            <form action="{{route('student.add.alert')}}" method="post">
                @csrf
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="form-group">
