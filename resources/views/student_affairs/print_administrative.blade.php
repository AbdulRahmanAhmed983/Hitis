                    ...
                    <div class="col-12 row justify-content-around">
                        ...
                        <div class="col-6">
                            <div class="form-group text-right">
                                <svg id="barcode"></svg>
                                 {{$payments_administrative->amount}}
                            </div>
                            <div class="form-group row">
                                <label class="col-4 control-label" for="ticket_id">رقم الحافظة</label>
                                <div class="col-8 font-weight-bolder">
                                    <h5 id="ticket_id">{{$payments_administrative->ticket_id}}</h5>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-4 control-label" for="date">تاريخ الحافظة</label>
                                <div class="col-8">
                                    <h5 id="date">{{$payments_administrative->date}}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        JsBarcode("#barcode", "{{$payments_administrative->ticket_id}}", {
            displayValue: false,
            fontSize: 25
        });
        window.print();
