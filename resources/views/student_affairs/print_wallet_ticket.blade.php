        ...
        <div class="col-12 mb-5">
            <div class="card">
                <div class="card-header d-flex">
                    <h2 class="col-6 text-dark my-auto">حافظة محفظة طالب</h2>
                    <div class="col-2"></div>
                ...
                <div class="card-body">
                    <div class="col-12 row justify-content-around">
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label class="col-4 control-label" for="specialization">نوع الحافظة</label>
                                <div class="col-8">
                                    <h5 id="specialization">{{$student['type']}}</h5>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label class="col-4 control-label" for="amount">بيان السداد</label>
                                <div class="col-8">
                                    <h2 id="amount">{{$student['note']}}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        window.onafterprint = function () {
            window.location.replace("{{route('create.wallet.ticket')}}");
        };
    </script>
@endsection
