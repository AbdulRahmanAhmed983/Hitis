...
@section('title', ' بحث عن طالب له مصاريف ادارية سابقة' )
@section('styles')
@endsection
@section('content')
    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    @if(!is_null($payments_administrative))
                                        <div class="form-group">
                                            <label for="payments_administrative">رقم اللجنة</label>
                                            <input type="text" value="{{$payments_administrative->place}}" readonly required
                                                   class="form-control" name="payments_administrative" id="payments_administrative">
                                        </div>
                                    @endif
                                </div>
                                <div class="col-6">
