...
<body>
    ...
    <div class="card">
        <div class="header">
            ...
            <div class="nav">
                <div class="flex">
                    <div class="flex-content ar">المعهد العالى للسياحة والفنادق وترميم الآثار  </div>
                    <div class="flex-content en">High institute for Tourism, Hotels and Restoration</div>
                </div>
